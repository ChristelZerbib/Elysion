 ...
 */
final class Version20200701170030 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE alloys_list (id INT AUTO_INCREMENT NOT NULL, bonus_1_id INT DEFAULT NULL, bonus_2_id INT DEFAULT NULL, bonus_3_id INT DEFAULT NULL, bonus_4_id INT DEFAULT NULL, malus_1_id INT DEFAULT NULL, malus_2_id INT DEFAULT NULL, malus_3_id INT DEFAULT NULL, effect_1_id INT DEFAULT NULL, effect_2_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, isunique TINYINT(1) NOT NULL, description VARCHAR(3000) NOT NULL, bought TINYINT(1) NOT NULL, used TINYINT(1) NOT NULL, type VARCHAR(50) NOT NULL, support VARCHAR(50) NOT NULL, support_3 VARCHAR(255) DEFAULT NULL, support_2 VARCHAR(255) DEFAULT NULL, price INT NOT NULL, INDEX IDX_A91349C428111BD8 (bonus_1_id), INDEX IDX_A91349C43AA4B436 (bonus_2_id), INDEX IDX_A91349C48218D353 (bonus_3_id), INDEX IDX_A91349C41FCFEBEA (bonus_4_id), INDEX IDX_A91349C453FD9CBA (malus_1_id), INDEX IDX_A91349C441483354 (malus_2_id), INDEX IDX_A91349C4F9F45431 (malus_3_id), INDEX IDX_A91349C460B66B03 (effect_1_id), INDEX IDX_A91349C47203C4ED (effect_2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE boats (id INT AUTO_INCREMENT NOT NULL, required_skill_id INT NOT NULL, maintenance INT NOT NULL, staff INT NOT NULL, glyph_max INT NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_8DDF0906CEC0E2D5 (required_skill_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE bonus_effects_list (id INT AUTO_INCREMENT NOT NULL, rank_id INT NOT NULL, up_feature_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, isunique TINYINT(1) NOT NULL, israre TINYINT(1) NOT NULL, description VARCHAR(1000) NOT NULL, add_glyph_place INT DEFAULT NULL, bought TINYINT(1) NOT NULL, special TINYINT(1) NOT NULL, evol_salary INT DEFAULT NULL, evol_maintenance DOUBLE PRECISION DEFAULT NULL, evol_staff DOUBLE PRECISION DEFAULT NULL, INDEX IDX_7228C73A7616678F (rank_id), INDEX IDX_7228C73AE4CDF10C (up_feature_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE glyphs_list (id INT AUTO_INCREMENT NOT NULL, rarity_id INT NOT NULL, ingredient_type_id INT NOT NULL, characters_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, price INT NOT NULL, isunique TINYINT(1) NOT NULL, description VARCHAR(1000) NOT NULL, bought TINYINT(1) NOT NULL, used TINYINT(1) NOT NULL, effect VARCHAR(50) NOT NULL, support VARCHAR(50) NOT NULL, special TINYINT(1) NOT NULL, support_2 VARCHAR(255) DEFAULT NULL, support_3 VARCHAR(255) DEFAULT NULL, evol_salary INT NOT NULL, evol_maintenance NUMERIC(2, 1) DEFAULT NULL, evol_staff NUMERIC(2, 1) DEFAULT NULL, personalization TINYINT(1) NOT NULL, INDEX IDX_C3C33044F3747573 (rarity_id), INDEX IDX_C3C33044C47B8755 (ingredient_type_id), INDEX IDX_C3C33044C70F0E28 (characters_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE objects_list (id INT AUTO_INCREMENT NOT NULL, title_id INT DEFAULT NULL, subtype_id INT NOT NULL, alloy_id INT DEFAULT NULL, rarity_id INT NOT NULL, characters_id INT DEFAULT NULL, boat_id INT DEFAULT NULL, legend_id INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(2000) NOT NULL, comment VARCHAR(2000) DEFAULT NULL, shop VARCHAR(255) NOT NULL, price INT NOT NULL, max_number INT DEFAULT NULL, personalization TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_EDA019ACA9F87BD (title_id), INDEX IDX_EDA019AC8E2E245C (subtype_id), UNIQUE INDEX UNIQ_EDA019ACDE168554 (alloy_id), INDEX IDX_EDA019ACF3747573 (rarity_id), INDEX IDX_EDA019ACC70F0E28 (characters_id), INDEX IDX_EDA019ACA1E84A29 (boat_id), INDEX IDX_EDA019ACD93B9119 (legend_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE objects_list_glyphs_list (objects_list_id INT NOT NULL, glyphs_list_id INT NOT NULL, INDEX IDX_5718ED00FBF56B29 (objects_list_id), INDEX IDX_5718ED00CCF94516 (glyphs_list_id), PRIMARY KEY(objects_list_id, glyphs_list_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE up_feature (id INT AUTO_INCREMENT NOT NULL, feature_id INT NOT NULL, up_quantity INT NOT NULL, temporary TINYINT(1) NOT NULL, INDEX IDX_DF4AE0D60E4B879 (feature_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE objects_list_glyphs_list ADD CONSTRAINT FK_5718ED00FBF56B29 FOREIGN KEY (objects_list_id) REFERENCES objects_list (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE objects_list_glyphs_list ADD CONSTRAINT FK_5718ED00CCF94516 FOREIGN KEY (glyphs_list_id) REFERENCES glyphs_list (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE objects_list_glyphs_list DROP FOREIGN KEY FK_5718ED00CCF94516');
        ...
        $this->addSql('ALTER TABLE objects_list_glyphs_list DROP FOREIGN KEY FK_5718ED00FBF56B29');
        ...
        $this->addSql('DROP TABLE objects_list_glyphs_list');
